...
aliases:
  - "state.sqlite p2_ladder_policies"
  - "table p2_ladder_policies"
schema_head: 156
table_name: "p2_ladder_policies"
...
| `policy_version` | `INTEGER` | yes | `1` | — | Stored value |
| `schema_version` | `INTEGER` | yes | `1` | — | Stored value |
...
- `sqlite_autoindex_p2_ladder_policies_2` on `policy_slug`, `policy_version` (unique).
- `sqlite_autoindex_p2_ladder_policies_1` on `id` (unique).

## Who calls it

### Repository access surface

- `Repository.active_ladder_policy()`
