...
aliases:
  - "state.sqlite diagnostic_packs"
  - "table diagnostic_packs"
schema_head: 156
table_name: "diagnostic_packs"
...
| `pack_slug` | `TEXT` | yes | — | — | Stored value |
...
- `idx_diag_packs_blueprint` on `blueprint_version_id`.
- `sqlite_autoindex_diagnostic_packs_2` on `pack_slug` (unique).
- `sqlite_autoindex_diagnostic_packs_1` on `id` (unique).

## Who calls it

### Repository access surface

- `Repository.diagnostic_pack()`
- `Repository.diagnostic_pack_by_slug()`
- `Repository.diagnostic_packs_for_blueprint()`
