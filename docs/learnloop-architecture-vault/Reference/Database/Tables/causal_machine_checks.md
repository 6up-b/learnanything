...
aliases:
  - "state.sqlite causal_machine_checks"
  - "table causal_machine_checks"
schema_head: 156
table_name: "causal_machine_checks"
table_role: "receipt"
...
- **Schema touched by:** `124_causal_probe_decisions.sql`, `139_certification_cold_probes.sql`.
...
| `factor_id` | `TEXT` | no | — | — | Application-validated soft reference |
...
- `idx_causal_machine_checks_open` on `status`, `learning_object_id`, `factor_id`, `created_at`, `id`.
- `sqlite_autoindex_causal_machine_checks_1` on `id` (unique).

## Who calls it

### Repository access surface

- `Repository.causal_machine_check()`
- `Repository.causal_machine_checks()`
- `Repository.close_causal_machine_check()`
- `Repository.enqueue_causal_machine_check()`
