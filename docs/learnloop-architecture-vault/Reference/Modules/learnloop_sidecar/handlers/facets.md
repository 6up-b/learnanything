---
title: "learnloop_sidecar.handlers.facets"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop_sidecar/handlers/facets.py"
source_paths:
...
aliases:
  - "learnloop_sidecar.handlers.facets module"
  - "src/learnloop_sidecar/handlers/facets.py"
tags:
  - "docs/module"
...
# `learnloop_sidecar.handlers.facets`
...
This module keeps facets behavior inside its owning package, [[Reference/Modules/learnloop_sidecar/handlers/_package|learnloop_sidecar.handlers]]. Its public surface centers on `get_facet_mastery`.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop_sidecar/handlers/facets.py](../../../../../../src/learnloop_sidecar/handlers/facets.py) |
| Source lines | 170 |
...
- `get_facet_mastery(ctx: SidecarContext, _params) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/facets.py), line 17) — Evidence-facet mastery rollup powering the radar chart.

### Module constants

- `_STATES` ([src/learnloop_sidecar/handlers/facets.py](../../../../../../src/learnloop_sidecar/handlers/facets.py), line 12)
- `_TITLE_MAX` ([src/learnloop_sidecar/handlers/facets.py](../../../../../../src/learnloop_sidecar/handlers/facets.py), line 13)

## Internal implementation anchors

- `_facet_mastery(facet_id: str, row: dict[str, Any]) -> float` ([source](../../../../../../src/learnloop_sidecar/handlers/facets.py), line 159)
- `_item_title(prompt: str) -> str` ([source](../../../../../../src/learnloop_sidecar/handlers/facets.py), line 166)
...
1. Modify [src/learnloop_sidecar/handlers/facets.py](../../../../../../src/learnloop_sidecar/handlers/facets.py) and its owning tests.
