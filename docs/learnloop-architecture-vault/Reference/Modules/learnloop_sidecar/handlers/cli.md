---
title: "learnloop_sidecar.handlers.cli"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop_sidecar/handlers/cli.py"
source_paths:
...
aliases:
  - "learnloop_sidecar.handlers.cli module"
  - "src/learnloop_sidecar/handlers/cli.py"
tags:
  - "docs/module"
...
# `learnloop_sidecar.handlers.cli`
...
This module keeps cli behavior inside its owning package, [[Reference/Modules/learnloop_sidecar/handlers/_package|learnloop_sidecar.handlers]]. Its public surface centers on `RunCliCommandInput`, `run_cli_command`.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop_sidecar/handlers/cli.py](../../../../../../src/learnloop_sidecar/handlers/cli.py) |
| Source lines | 108 |
...
- `class RunCliCommandInput(ParamsModel)` ([source](../../../../../../src/learnloop_sidecar/handlers/cli.py), line 15)
- `run_cli_command(ctx: SidecarContext, params: RunCliCommandInput) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/cli.py), line 20)

## Internal implementation anchors

- `_cli_result(argv: list[str], exit_code: int, stdout: str, stderr: str) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/cli.py), line 89)
- `_should_inject_vault(argv: list[str]) -> bool` ([source](../../../../../../src/learnloop_sidecar/handlers/cli.py), line 100)
...
- Standard library: `__future__`, `os`, `pathlib`, `subprocess`, `sys`, `typing`
...
1. Modify [src/learnloop_sidecar/handlers/cli.py](../../../../../../src/learnloop_sidecar/handlers/cli.py) and its owning tests.
