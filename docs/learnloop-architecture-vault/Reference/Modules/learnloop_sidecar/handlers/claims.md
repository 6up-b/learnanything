---
title: "learnloop_sidecar.handlers.claims"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop_sidecar/handlers/claims.py"
source_paths:
...
aliases:
  - "learnloop_sidecar.handlers.claims module"
  - "src/learnloop_sidecar/handlers/claims.py"
tags:
  - "docs/module"
...
# `learnloop_sidecar.handlers.claims`
...
This module keeps claims behavior inside its owning package, [[Reference/Modules/learnloop_sidecar/handlers/_package|learnloop_sidecar.handlers]]. Its public surface centers on `ClaimCandidateInput`, `PresentClaimsInput`, `RespondClaimInput`, `DismissClaimInput`, `present_claims_handler`, `respond_claim_handler`, `dismiss_claim_handler`, `export_claims_handler` and 1 more public symbols.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop_sidecar/handlers/claims.py](../../../../../../src/learnloop_sidecar/handlers/claims.py) |
| Source lines | 95 |
...
- `class ClaimCandidateInput(ParamsModel)` ([source](../../../../../../src/learnloop_sidecar/handlers/claims.py), line 19)
- `class PresentClaimsInput(ParamsModel)` ([source](../../../../../../src/learnloop_sidecar/handlers/claims.py), line 34)
- `class RespondClaimInput(ParamsModel)` ([source](../../../../../../src/learnloop_sidecar/handlers/claims.py), line 40)
- `class DismissClaimInput(ParamsModel)` ([source](../../../../../../src/learnloop_sidecar/handlers/claims.py), line 45)
- `present_claims_handler(ctx: SidecarContext, params: PresentClaimsInput) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/claims.py), line 50)
- `respond_claim_handler(ctx: SidecarContext, params: RespondClaimInput) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/claims.py), line 67)
- `dismiss_claim_handler(ctx: SidecarContext, params: DismissClaimInput) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/claims.py), line 77)
- `export_claims_handler(ctx: SidecarContext, _params: ParamsModel) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/claims.py), line 87)
- `purge_claims_handler(ctx: SidecarContext, _params: ParamsModel) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/claims.py), line 93)
...
- [[Reference/Modules/learnloop/learner/hypothesis_claims|learnloop.learner.hypothesis_claims]] — imports `HypothesisClaimError`, `dismiss_claim`, `export_claim_events`, `present_claims`, `purge_claim_events`, `record_response`; calls `dismiss_claim`, `export_claim_events`, `present_claims`, `purge_claim_events`, `record_response`
...
1. Modify [src/learnloop_sidecar/handlers/claims.py](../../../../../../src/learnloop_sidecar/handlers/claims.py) and its owning tests.
