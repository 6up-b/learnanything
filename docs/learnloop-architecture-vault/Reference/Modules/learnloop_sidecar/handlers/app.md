---
title: "learnloop_sidecar.handlers.app"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop_sidecar/handlers/app.py"
source_paths:
...
aliases:
  - "learnloop_sidecar.handlers.app module"
  - "src/learnloop_sidecar/handlers/app.py"
tags:
  - "docs/module"
...
# `learnloop_sidecar.handlers.app`
...
This module keeps app behavior inside its owning package, [[Reference/Modules/learnloop_sidecar/handlers/_package|learnloop_sidecar.handlers]]. Its public surface centers on `InitializeParams`, `RefreshVaultFilesInput`, `initialize`, `shutdown`, `rpc_ping`, `rpc_health`, `load_vault_handler`, `reload_vault_handler` and 4 more public symbols.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop_sidecar/handlers/app.py](../../../../../../src/learnloop_sidecar/handlers/app.py) |
| Source lines | 168 |
...
- `class InitializeParams(ParamsModel)` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 13)
- `class RefreshVaultFilesInput(ParamsModel)` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 18)
- `initialize(ctx: SidecarContext, params: InitializeParams) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 24)
- `shutdown(ctx: SidecarContext, _params) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 43)
- `rpc_ping(_ctx: SidecarContext, _params) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 51) — Process-level readiness probe that deliberately requires no vault.
- `rpc_health(ctx: SidecarContext, _params) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 68)
- `load_vault_handler(ctx: SidecarContext, _params) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 74)
- `reload_vault_handler(ctx: SidecarContext, _params) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 79)
- `refresh_vault_files(ctx: SidecarContext, params: RefreshVaultFilesInput) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 85) — Rust watcher handoff: incrementally refresh supported changed files.
- `get_runtime_health(ctx: SidecarContext, _params) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 94)
- `get_config(ctx: SidecarContext, _params) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 100)
- `get_review_counts(ctx: SidecarContext, _params) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/app.py), line 147) — Counts behind the nav-tab badges: what is waiting on the learner.

### Module constants

- `_BADGE_COUNT_QUERIES` ([src/learnloop_sidecar/handlers/app.py](../../../../../../src/learnloop_sidecar/handlers/app.py), line 112)
- `_MAINTAIN_BADGE_KEYS` ([src/learnloop_sidecar/handlers/app.py](../../../../../../src/learnloop_sidecar/handlers/app.py), line 138)
...
- [[Reference/Modules/learnloop_sidecar/__init__|learnloop_sidecar]] — imports `__version__`
- [[Reference/Modules/learnloop_sidecar/context|learnloop_sidecar.context]] — imports `SidecarContext`, `config_dto`, `runtime_health`, `vault_summary`; calls `config_dto`, `runtime_health`, `vault_summary`
- [[Reference/Modules/learnloop_sidecar/dto|learnloop_sidecar.dto]] — imports `ParamsModel`, `versioned`; calls `versioned`
- [[Reference/Modules/learnloop_sidecar/registry|learnloop_sidecar.registry]] — imports `METHOD_REGISTRY`, `method`; calls `method`
...
1. Modify [src/learnloop_sidecar/handlers/app.py](../../../../../../src/learnloop_sidecar/handlers/app.py) and its owning tests.
