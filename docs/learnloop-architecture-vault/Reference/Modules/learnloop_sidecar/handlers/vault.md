---
title: "learnloop_sidecar.handlers.vault"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop_sidecar/handlers/vault.py"
source_paths:
...
workflows:
  - "Initialize a Vault"
aliases:
  - "learnloop_sidecar.handlers.vault module"
  - "src/learnloop_sidecar/handlers/vault.py"
tags:
  - "docs/module"
...
# `learnloop_sidecar.handlers.vault`
...
This module keeps vault behavior inside its owning package, [[Reference/Modules/learnloop_sidecar/handlers/_package|learnloop_sidecar.handlers]]. Its public surface centers on `CreateVaultInput`, `create_vault`, `SetLearnerProfileInput`, `get_learner_profile`, `set_learner_profile`.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop_sidecar/handlers/vault.py](../../../../../../src/learnloop_sidecar/handlers/vault.py) |
| Source lines | 119 |
...
- `class CreateVaultInput(ParamsModel)` ([source](../../../../../../src/learnloop_sidecar/handlers/vault.py), line 12)
- `create_vault(ctx: SidecarContext, params: CreateVaultInput) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/vault.py), line 28) — Create (or re-initialize) a LearnLoop vault at ``path`` and return its root.
- `class SetLearnerProfileInput(ParamsModel)` ([source](../../../../../../src/learnloop_sidecar/handlers/vault.py), line 66)
- `get_learner_profile(ctx: SidecarContext, params: EmptyParams) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/vault.py), line 72) — The vault's declared learner level (profile/learner.yaml), or nulls.
- `set_learner_profile(ctx: SidecarContext, params: SetLearnerProfileInput) -> dict[str, Any]` ([source](../../../../../../src/learnloop_sidecar/handlers/vault.py), line 90) — Write profile/learner.yaml and replace the global init-wizard claim.
...
- [[Reference/Modules/learnloop/learner/learner_profile|learnloop.learner.learner_profile]] — imports `read_learner_profile`, `seed_global_learner_claim`, `write_learner_profile`; calls `read_learner_profile`, `seed_global_learner_claim`, `write_learner_profile`
...
1. Modify [src/learnloop_sidecar/handlers/vault.py](../../../../../../src/learnloop_sidecar/handlers/vault.py) and its owning tests.
