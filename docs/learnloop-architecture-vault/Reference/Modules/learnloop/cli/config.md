---
title: "learnloop.cli.config"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop/cli/config.py"
source_paths:
...
This module keeps config behavior inside its owning package, [[Reference/Modules/learnloop/cli/_package|learnloop.cli]]. Its public surface centers on `config_effective`.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/cli/config.py](../../../../../../src/learnloop/cli/config.py) |
| Source lines | 42 |
...
- `config_effective(vault: Annotated[Path | None, typer.Option('--vault', help='Vault root.')]=None, only_overrides: Annotated[bool, typer.Option('--only-overrides', help='Show only keys explicitly present in learnloop.toml.')]=False, json_output: Annotated[bool, typer.Option('--json', help='Emit JSON instead of TOML.')]=False) -> None` ([source](../../../../../../src/learnloop/cli/config.py), line 8) — Print the modeled configuration that LearnLoop actually uses.
...
- Standard library: `__future__`, `tomllib`
- Third party: `tomlkit`
...
1. Modify [src/learnloop/cli/config.py](../../../../../../src/learnloop/cli/config.py) and its owning tests.
