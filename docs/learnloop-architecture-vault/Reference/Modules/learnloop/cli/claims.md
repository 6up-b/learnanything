---
title: "learnloop.cli.claims"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop/cli/claims.py"
source_paths:
...
This module keeps claims behavior inside its owning package, [[Reference/Modules/learnloop/cli/_package|learnloop.cli]]. Its public surface centers on `claims_export`, `claims_purge`.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/cli/claims.py](../../../../../../src/learnloop/cli/claims.py) |
| Source lines | 32 |
...
- `claims_export(output: Annotated[Path | None, typer.Option('--output', help='Optional JSON output path.')]=None, vault: Annotated[Path | None, typer.Option('--vault', help='Vault root.')]=None) -> None` ([source](../../../../../../src/learnloop/cli/claims.py), line 8) — Explicitly export the vault-local hypothesis event ledger.
- `claims_purge(vault: Annotated[Path | None, typer.Option('--vault', help='Vault root.')]=None) -> None` ([source](../../../../../../src/learnloop/cli/claims.py), line 24) — Delete all local hypothesis presentations and responses.
...
1. Modify [src/learnloop/cli/claims.py](../../../../../../src/learnloop/cli/claims.py) and its owning tests.
