---
title: "learnloop.cli.controller"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop/cli/controller.py"
source_paths:
...
aliases:
  - "learnloop.cli.controller module"
  - "src/learnloop/cli/controller.py"
tags:
  - "docs/module"
...
This module keeps controller behavior inside its owning package, [[Reference/Modules/learnloop/cli/_package|learnloop.cli]]. Its public surface centers on `controller_open_world_gate`.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/cli/controller.py](../../../../../../src/learnloop/cli/controller.py) |
| Source lines | 41 |
...
- `controller_open_world_gate(vault: Annotated[Path | None, typer.Option('--vault', help='Vault root.')]=None, json_output: Annotated[bool, typer.Option('--json', help='Emit the JSON gate report.')]=False) -> None` ([source](../../../../../../src/learnloop/cli/controller.py), line 11) — Evaluate the six §14.1 dependency conditions that gate open-world HypothesisCard expansion.
...
- [[Reference/Modules/learnloop/scheduling/open_world_gate|learnloop.scheduling.open_world_gate]] — imports `module`; calls `evaluate_gate`
...
1. Modify [src/learnloop/cli/controller.py](../../../../../../src/learnloop/cli/controller.py) and its owning tests.
