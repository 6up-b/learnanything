...
version: "1.0.0"
source_path: "src/learnloop/db/__init__.py"
source_paths:
...
`learnloop.db` exists within [[Reference/Modules/learnloop/db/_package|learnloop.db]] to own the behavior summarized by its module contract: SQLite connection, migration, and repositories.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/db/__init__.py](../../../../../../src/learnloop/db/__init__.py) |
| Source lines | 1 |
...
1. Modify [src/learnloop/db/__init__.py](../../../../../../src/learnloop/db/__init__.py) and its owning tests.
