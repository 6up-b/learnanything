---
title: "learnloop.db.stores"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop/db/stores/__init__.py"
source_paths:
...
`learnloop.db.stores` exists within [[Reference/Modules/learnloop/db/stores/_package|learnloop.db.stores]] to own the behavior summarized by its module contract: Write-family stores and explicitly named cross-family read models.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/db/stores/__init__.py](../../../../../../../src/learnloop/db/stores/__init__.py) |
| Source lines | 1 |
...
1. Modify [src/learnloop/db/stores/__init__.py](../../../../../../../src/learnloop/db/stores/__init__.py) and its owning tests.
