...
version: "1.0.0"
source_path: "src/learnloop/ops/__init__.py"
source_paths:
...
`learnloop.ops` exists within [[Reference/Modules/learnloop/ops/_package|learnloop.ops]] to own the behavior summarized by its module contract: Ops domain package.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/ops/__init__.py](../../../../../../src/learnloop/ops/__init__.py) |
| Source lines | 1 |
...
1. Modify [src/learnloop/ops/__init__.py](../../../../../../src/learnloop/ops/__init__.py) and its owning tests.
