...
version: "1.0.0"
source_path: "src/learnloop/ai/__init__.py"
source_paths:
...
`learnloop.ai` exists within [[Reference/Modules/learnloop/ai/_package|learnloop.ai]] to own the behavior summarized by its module contract: Provider-neutral AI contracts and composition helpers.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/ai/__init__.py](../../../../../../src/learnloop/ai/__init__.py) |
| Source lines | 39 |
...
- `_EXPORTS` ([src/learnloop/ai/__init__.py](../../../../../../src/learnloop/ai/__init__.py), line 13)

## Internal implementation anchors

- `__getattr__(name: str) -> Any` ([source](../../../../../../src/learnloop/ai/__init__.py), line 28)
- `__dir__() -> list[str]` ([source](../../../../../../src/learnloop/ai/__init__.py), line 38)
...
1. Modify [src/learnloop/ai/__init__.py](../../../../../../src/learnloop/ai/__init__.py) and its owning tests.
