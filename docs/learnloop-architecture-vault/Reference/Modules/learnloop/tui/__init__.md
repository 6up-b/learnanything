...
version: "1.0.0"
source_path: "src/learnloop/tui/__init__.py"
source_paths:
...
`learnloop.tui` exists within [[Reference/Modules/learnloop/tui/_package|learnloop.tui]] to own the behavior summarized by its module contract: Textual TUI.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/tui/__init__.py](../../../../../../src/learnloop/tui/__init__.py) |
| Source lines | 1 |
...
1. Modify [src/learnloop/tui/__init__.py](../../../../../../src/learnloop/tui/__init__.py) and its owning tests.
