---
title: "learnloop.vault"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop/vault/__init__.py"
source_paths:
...
`learnloop.vault` exists within [[Reference/Modules/learnloop/vault/_package|learnloop.vault]] to own the behavior summarized by its module contract: Vault loading and YAML persistence.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/vault/__init__.py](../../../../../../src/learnloop/vault/__init__.py) |
| Source lines | 1 |
...
1. Modify [src/learnloop/vault/__init__.py](../../../../../../src/learnloop/vault/__init__.py) and its owning tests.
