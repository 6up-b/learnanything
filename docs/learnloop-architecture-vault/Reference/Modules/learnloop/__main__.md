---
title: "learnloop.__main__"
type: "module-reference"
status: "current"
refactor_status: "ACTIVE"
version: "1.0.0"
source_path: "src/learnloop/__main__.py"
source_paths:
...
This module is a source-level boundary within [[Reference/Modules/learnloop/_package|learnloop]]; it currently exposes no top-level definitions.
...
| Fact | Value |
|---|---|
| Source | [src/learnloop/__main__.py](../../../../../src/learnloop/__main__.py) |
| Source lines | 5 |
...
- Make changes here when the responsibility remains main within learnloop; otherwise move the behavior to its owning boundary.
- Run the directly importing tests below, then the architecture/import-linter checks when imports or public ownership change.

### Regeneration and review checklist

1. Modify [src/learnloop/__main__.py](../../../../../src/learnloop/__main__.py) and its owning tests.
