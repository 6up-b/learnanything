...
def _is_alias_only_facet_append(item: GateItem, ctx: GateContext) -> bool:
    ...
    The D2 mint gate (Meas D2, ``learnloop.content.synthesis.facet_mint_gate``)
    refuses to mint a
...
#: Public aliases. The D2 mint gate
#: (``learnloop.content.synthesis.facet_mint_gate``) discovers its
