...
``learnloop.curriculum.integration_backfill``. This module follows D3's shape
deliberately:
...
§3.0 authoring gate (``learnloop.content.authoring.persona_gate``) grades with —
so the mint gate and
...
from learnloop.content.synthesis.synthesis_gates import facet_tokens, jaccard
