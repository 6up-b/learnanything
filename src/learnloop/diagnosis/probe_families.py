...
def map_episode_labels_to_slots(
    ...
    *,
    ...
    from learnloop.diagnosis.probe_hypotheses import CONFUSES_PREFIX, MISCONCEPTION_PREFIX
...
# (``learnloop.diagnosis.longform_trace``): the generated rubric carries one
# criterion per
