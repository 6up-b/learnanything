...
from learnloop.diagnosis.misconceptions import normalize_and_resolve_attempt
from learnloop.db.repositories import MisconceptionRecord, Repository
from learnloop.learner.facet_diagnostics import candidate_facet_support
...
from learnloop.diagnosis.predictive_eig import TargetItemModel, build_target_models, predictive_facet_eig
...
from learnloop.learner.recall_coverage import familiarity_discount
from learnloop.diagnosis.signal_quantiles import ResolvedThreshold, resolve_followup_thresholds
...
def common_repair_messages() -> dict[str, str]:
    ...
    from learnloop.diagnosis.causal_orchestrator import SAFE_COMMON_REPAIR_MESSAGE
...
def _probe_unfamiliar_probability(
    ...
    if episode is not None and episode.hypothesis_set_id is not None:
        from learnloop.diagnosis.probe_episodes import episode_posterior
        from learnloop.diagnosis.probe_hypotheses import H_OTHER, H_UNFAMILIAR
