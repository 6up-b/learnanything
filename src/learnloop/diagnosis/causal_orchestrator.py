...
from learnloop.diagnosis import causal_diagnostic_selector as shadow_selector
...
#: ``learnloop.diagnosis.causal_probe_commissioning.commission_probe_instrument``.
...
def _durable_case_factor(
    ...
    from learnloop.diagnosis.causal_attribution import _normalized
...
def _avoided_overteaching_minutes(
    ...
    *,
    ...
    receipt = diagnosis_receipt(repository, attempt_id)
...
def episode_conflict_reason(
    ...
    from learnloop.diagnosis.probe_episodes import episode_has_observations
...
def _probe_production_admissibility(
    ...
    from learnloop.attempts.reveal_ledger import production_admissibility
    ...
    *,
    ...
    if repair_class_id is None and episode.get("case_kind") == "misconception":
        ...
        for attempt_id in repository.attempt_ids_for_misconception(
            ...
            repair_class_id = _receipt_repair_class_id(
                diagnosis_receipt(repository, attempt_id)
            )
