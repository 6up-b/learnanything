...
**points** adjudication exists
(``learnloop.attempts.grade_resolution.append_adjudication``,
...
class DiagnosisSnapshot:
    ...
    (``learnloop.substrate.replay``). An eval record that had to re-read it
    would silently
...
def append_diagnosis_adjudication(
    ...
    *,
    ...
    (``learnloop.tutor.durable_promotion``): an affirming verdict promotes the
    asserted
