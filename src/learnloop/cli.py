...
# ---------------------------------------------------------------------------
# Diagnosis adjudication sub-app (spec_diagnostic_augmentation_v1.md §2 A4).
#
# Sibling of `learnloop grading adjudicate` above, deliberately: A4 says to
# follow the grade-points pattern rather than invent a divergent one. The write
# path is one command; `queue` and `scoreboard` are read-only adjuncts, because
# an annotation chore nobody can find work for is one nobody does.
# ---------------------------------------------------------------------------
...
def diagnosis_queue(
    ...
    from learnloop.services.diagnosis_adjudication import adjudication_queue
