...
from learnloop.learner.capability_mapping import CriterionOutcome, localize_criterion_outcomes
...
from learnloop.learner.recall_coverage import criterion_facet_weights_for_item, resolve_coverage
...
def request_grading_proposal(
    client: OperationClient,
    context: GradingContext,
) -> GradingProposal:
    """Run the feature-owned grading operation on a structured provider."""
...
def build_grading_context(
    ...
    *,
    ...
    return GradingContext(
        ...
        # ``learnloop.attempts.ai_contracts.GradingContext``.
        error_hunt_solution=(
...
def causal_attribution_audit_report(repository: Any) -> dict[str, Any]:
    ...
    from learnloop.diagnosis.discrimination_profiles import ProfileMatchOutcome
