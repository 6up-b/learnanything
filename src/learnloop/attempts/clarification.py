...
from learnloop.attempts.grading import PROVISIONAL_PENDING_CLARIFICATION
...
def row_to_clarification(row: Any) -> Clarification:
...
def pending_clarification(
    ...
    if row is None:
        return None
    record = row_to_clarification(row)
