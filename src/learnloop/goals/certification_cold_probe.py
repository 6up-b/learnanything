...
from learnloop.params.fitted_params import CERTIFICATION_COLD_PROBE_SCOPE
...
def select_held_out_probe_item(
    ...
    from learnloop.learner.contract_reachability import build_instrument_pool
...
class FalseCertificationRate:
    ...
    * ``indeterminate`` — probed, but the probe could not speak to the
    ...
    #
    # ``learnloop.diagnosis.scoreboard`` composes this metric rather than
    # reimplementing
