...
def reserve_exam_pool(
    ...
    *,
    ...
    from learnloop.scheduling.controller_ownership import staged_owned_practice_item_ids
    ...
    if _conflict:
        from learnloop.scheduling.controller_ownership import ExamReservationOwnershipConflict
