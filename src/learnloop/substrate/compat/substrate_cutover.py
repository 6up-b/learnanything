...
from learnloop.substrate import administration_adapters as _adapters
from learnloop.substrate.administration_adapters import OpportunisticDiagnosisRejected
...
def submit_administration_response(
    ...
    *,
    ...
    from learnloop.substrate import activities as _activities
...
def _gate3_probe_lineage(repository: Repository, clock: Clock | None) -> str:
    ...
    from learnloop.substrate import activities as _activities
    from learnloop.substrate import card_lineage as _lineage
    ...
    cv = repository.ensure_activity_card_version(
        ...
        card_contract_hash=_activities.canonical_hash(contract),
        contract_json=_activities.canonical_json(contract), schema_version=1, clock=clock,
    )
...
def _gate_new_scheduling_projection(
    ...
    from learnloop.scheduling.fsrs import FSRS6_DEFAULT_WEIGHTS, Rating, apply_review
