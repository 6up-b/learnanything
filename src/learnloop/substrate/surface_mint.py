...
def request_candidates(
    ...
    *,
    ...
    angle_json = canonical_json(dict(requested_angle)) if requested_angle is not None else ""
    return repository.enqueue_surface_mint_request(
        ...
        token_cost_json=canonical_json(dict(token_cost)) if token_cost is not None else None,
        clock=clock,
    )
...
def process_mint_job(
    ...
    *,
    ...
    cand_surface_id = candidate.get("surface_id")
    gate_json = canonical_json(result.as_dict() | {"reviewer": reviewer})
...
def _mark_surface_admitted(
    ...
    fields["gate_decision_json"] = canonical_json(gate_result.as_dict())
...
def admit_candidate(
    ...
    *,
    ...
    applied = repository.resolve_surface_mint_request(
        ...
        gate_results_json=canonical_json(gate_result.as_dict()),
...
def reject_candidate(
    ...
    *,
    ...
    repository.resolve_surface_mint_request(
        ...
        gate_results_json=canonical_json(gate_result.as_dict()) if gate_result is not None else None,
