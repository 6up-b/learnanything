...
from learnloop.substrate.activities import canonical_hash, canonical_json
...
def ensure_builtin_task_feature_schema(
    ...
    *,
    ...
    return repository.ensure_task_feature_schema_version(
        ...
        version=version,
        dimensions_json=canonical_json(_TASK_FEATURE_DIMENSIONS),
...
def _fields_to_columns(fields: Mapping[str, Any]) -> dict[str, Any]:
    return {
        "allowed_purposes_json": canonical_json(sorted(fields.get("allowed_purposes") or [])),
        "operation": fields["operation"],
        "learning_process": fields["learning_process"],
        "allowed_target_kinds_json": canonical_json(sorted(fields.get("allowed_target_kinds") or [])),
        "allowed_capabilities_json": canonical_json(sorted(fields.get("allowed_capabilities") or [])),
        "completion_semantics_json": canonical_json(fields.get("completion_semantics") or {}),
        "response_contract_json": canonical_json(fields.get("response_contract") or {}),
        "progression_role": fields.get("progression_role"),
        "prerequisite_evidence_json": canonical_json(fields.get("prerequisite_evidence") or {}),
        "feedback_strategy_json": canonical_json(fields.get("feedback_strategy") or {}),
        "assistance_strategy_json": canonical_json(fields.get("assistance_strategy") or {}),
        "evidence_semantics_by_context_json": canonical_json(fields.get("evidence_semantics_by_context") or {}),
        "task_feature_bounds_json": canonical_json(fields.get("task_feature_bounds") or {}),
        "variation_axes_json": canonical_json(fields.get("variation_axes") or {}),
        "rubric_shape_json": canonical_json(fields.get("rubric_shape") or {}),
        "mint_gates_json": canonical_json(fields.get("mint_gates") or {}),
        "burden_model_json": canonical_json(fields.get("burden_model") or {}),
