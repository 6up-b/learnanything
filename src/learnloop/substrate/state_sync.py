...
def sync_vault_state(
    ...
    *,
    ...
    from learnloop.diagnosis.probe_instance_generation import pending_review_instance_ids
    ...
    from learnloop.diagnosis.probe_episodes import enter_stale_uncertainty_reprobes
    ...
    from learnloop.scheduling.shadow_components import retire_expired_telemetry
