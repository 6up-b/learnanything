...
from learnloop.codex.prompts import BANNED_RESPONSE_MODES, LOW_MASTERY_RESPONSE_MODES
...
# The prompt ladder and the gate share one vocabulary (codex/prompts.py); a
