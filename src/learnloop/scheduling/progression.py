...
from learnloop.scheduling.progression_policy import SIBLING_SUCCESS_SHRINKAGE
...
def next_growth_activity(
    ...
    *,
    ...
    from learnloop.substrate.activities import resolve_progression_policy
...
def ensure_default_evidence_cap_policy(
    ...
    return repository.ensure_family_evidence_cap_policy(
        policy_slug=DEFAULT_CAP_POLICY_SLUG, version=1, caps_json=canonical_json(body),
        content_hash=canonical_hash(body), clock=clock,
    )
...
def link_retry(
    ...
    *,
    ...
    repository.update_lapse_episode(
        ...
        retry_observations_json=canonical_json(retries),
