...
def request_teach_back_question(
    client: OperationClient,
    context: TeachBackQuestionContext,
) -> TeachBackQuestion:
    """Run the feature-owned teach-back question operation."""

    return execute_structured_operation(
        client,
        purpose="teach_back",
        prompt=teach_back_question_prompt(context),
        result_model=TeachBackQuestion,
        legacy_capability="teach_back",
        legacy_context=context,
    )


def request_teach_back_authoring(
    client: OperationClient,
    context: TeachBackAuthoringContext,
) -> TeachBackAuthoring:
    """Run the feature-owned teach-back item-authoring operation."""

    return execute_structured_operation(
        client,
        purpose="teach_back_authoring",
        prompt=teach_back_authoring_prompt(context),
        result_model=TeachBackAuthoring,
        legacy_capability="teach_back_authoring",
        legacy_context=context,
    )
...
def next_question(
    ...
    *,
    ...
    question = request_teach_back_question(client, context)
...
def _run_teach_back_authoring(
    ...
    *,
    ...
    if client is None:
        return None
    try:
        authored = TeachBackAuthoring.model_validate(
            request_teach_back_authoring(client, context)
        )
