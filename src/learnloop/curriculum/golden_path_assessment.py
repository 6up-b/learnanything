...
from learnloop.attempts.grade_resolution import PROJECTION_ALGORITHM_VERSION, resolve_grade
...
def submit_assessment(
    ...
    *,
    ...
    repository.append_golden_path_artifact(
        ...
        administration_id=administration_id,
        payload_json=canonical_json({"schema_version": ASSESSMENT_SNAPSHOT_SCHEMA_VERSION, **result.as_dict()}),
