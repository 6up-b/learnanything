...
def register_blueprint_version(
    ...
    *,
    ...
    blueprint_canonical_hash = content_hash
    ...
    result = repository.register_task_blueprint_version(
        ...
        spec_json=canonical_json(body),
        content_hash=content_hash,
        canonical_hash=blueprint_canonical_hash,
        authoring_version=authoring_version,
        model_version=model_version,
        provenance_version=provenance_version,
        exemplars=_exemplar_rows(body),
        detail_json=canonical_json({"exemplar_count": len(body.get("exemplars") or [])}),
        author=author,
        clock=clock,
    )
...
def review_blueprint_version(
    ...
    *,
    ...
    repository.transition_task_blueprint_version(
        ...
        status="reviewed",
        event_kind="reviewed",
        detail_json=canonical_json(dict(checks)) if checks else None,
        author=author,
        clock=clock,
    )
...
def place_reading_question(
    ...
    *,
    ...
    return repository.append_task_blueprint_review_event(
        ...
        detail_json=canonical_json(dict(placement)),
        author=author,
        clock=clock,
    )
