...
from learnloop.curriculum.golden_path_assessment import DEMONSTRATED_CLAIM_CERTAINTY
    ...
    *,
    ...
    if repository.latest_golden_path_artifact(run_id, kind="milestone") is None:
        ...
        repository.append_golden_path_artifact(
            ...
            payload_json=canonical_json({"milestone_slug": milestone, "event_only": True}),
    ...
    repository.append_golden_path_artifact(
        ...
        payload_json=canonical_json(invitation),
    ...
    *,
    ...
    if repository.latest_golden_path_artifact(run_id, kind="boundary_diff") is None:
        repository.append_golden_path_artifact(
            ...
            payload_json=canonical_json(diff),
    ...
    if repository.latest_golden_path_artifact(run_id, kind="restoration") is None:
        repository.append_golden_path_artifact(
            ...
            payload_json=canonical_json({"schema_version": RESTORATION_SCHEMA_VERSION, **receipt.as_dict()}),
