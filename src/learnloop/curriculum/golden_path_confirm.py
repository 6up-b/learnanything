...
def confirm_exemplar_and_start(
    ...
    *,
    ...
    version_fields: dict[str, Any] = {
        ...
        "hiatus_hint": None,
        "reason": None,
        "provenance_json": canonical_json({"golden_path": True, "blueprint_version_id": blueprint_version_id}),
    ...
    if assessment_surface_id is not None:
        ...
        reservation_payload = {
            ...
            "eligibility_json": canonical_json(dict(assessment_eligibility) if assessment_eligibility else {}),
        }
    ...
    result = repository.confirm_golden_path_atomic(
        ...
        run={
            ...
            "mode": mode,
            "orchestration_policy_json": canonical_json(dict(orchestration_policy)) if orchestration_policy else None,
            "decision_param_manifest_json": canonical_json(dict(decision_param_manifest)) if decision_param_manifest else None,
            "visible_caps_json": canonical_json(dict(visible_caps)) if visible_caps else None,
        },
